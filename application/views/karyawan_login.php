...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>K</b>ing<b>K</b>ong</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Welcome our dear employee</p>

    <form action="<?php echo base_url('login/karyawan_dologin')?>" method="post">
